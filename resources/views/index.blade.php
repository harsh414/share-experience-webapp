            ...
            <div class="description py-2 pl-1 pr-3">
                <div class="flex-col">
                    ...
                    <div class="flex items-center justify-start px-4 md:mt-6 ml-4">
                        ...
                        <div class="text-gray-500 text-xs space-x-2 ml-1">3 comments</div>
                        <div class="flex ml-52 sm:ml-52 md:ml-28">
                            <button class="bg-gray-300 rounded-xl font-semibold px-4 py-0.5 mb-1">
                                Open
                            </button>
                            <button class="relative bg-gray-100 focus:outline-none rounded-full h-7 px-2 py-0.5 ml-3" x-data="{toggleOpen:false}"
                                    @click="toggleOpen=!toggleOpen" @click.away="toggleOpen=!toggleOpen">
                                <svg fill="currentColor" width="24" height="6"><path d="M2.97.061A2.969 2.969 0 000 3.031 2.968 2.968 0 002.97 6a2.97 2.97 0 100-5.94zm9.184 0a2.97 2.97 0 100 5.939 2.97 2.97 0 100-5.939zm8.877 0a2.97 2.97 0 10-.003 5.94A2.97 2.97 0 0021.03.06z" style="color: rgba(163, 163, 163, .5)"></svg>
                                <ul class="absolute text-left space-y-2 pl-2 ml-12 w-36 sm:w-36 md:w-44 shadow-lg bg-white rounded-xl py-2" x-show="toggleOpen">
                                    <li>
